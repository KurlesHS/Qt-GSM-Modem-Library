...
void QAtChatScript::runChatFile( const QString& filename )
{
    ...
    if ( file.open( QIODevice::ReadOnly ) ) {
        ...
        qDebug()<<"AtChat:" << "QAtChatScript::runChatFile: could not open" << filename;
        QAtResult result;
    ...
    switch ( d->state ) {
        ...
        case 0:
        {
            ...
            if ( !value.isEmpty() && value != "OK" &&
                ...
                qDebug()<<"AtChat:" << "QAtChatScript::word: odd expect string" << value;
            }
            d->state = 1;
        }
        break;
        ...
        case 1:
        {
            ...
            if ( value == "+++" ) {
                qDebug()<<"AtChat:" << "QAtChatScript::word: ignoring +++ hangup";
            } else {
                d->commands += value;
            }
            d->state = 0;
