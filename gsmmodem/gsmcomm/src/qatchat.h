...
class QAtChat : public QObject
{
    Q_OBJECT
public:
    explicit QAtChat(QSerialPort* device );
    ~QAtChat();
...
public:
    ...
    void registerNotificationType ( const QString& type, QObject *target,
...
signals:
    ...
    void notification (const QString &type, const QString &value);
